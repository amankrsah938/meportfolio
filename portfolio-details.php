...
<head>
  ...
  <title>Education Details - Personal Bootstrap Template</title>
...
if(isset($_GET['id'])){
  $id = $_GET['id'];
  $sql = "SELECT * FROM `Education` WHERE `Education`.`id` = $id";
...
?>
  <main id="main">
    ...
    <!-- ======= Education Details ======= -->
    <div id="Education-details" class="Education-details">
      <div class="container">

        <div class="row">

          <div class="col-lg-8">
            <div class="Education-details-slider swiper">
          ...
          <div class="col-lg-4 Education-info">
            <h3><?=$data['title']?></h3>
            <ul>
